...
public class TPvPDashboardScreen extends Screen {
    ...
    public void render(DrawContext context, int mx, int my, float delta) {
        ...
        // --- ALL 6 TABS INCLUDED (Nothing is removed) ---
        ...
        drawTab(context, "🛠 Edit HUD", winX, winY + 190, mx, my); // <--- PERFECTLY HERE!
    ...
    public boolean mouseClicked(double mx, double my, int button) {
        ...
        if (mx >= winX && mx <= winX + sideW) {
            ...
            else if (my >= winY+190 && my <= winY+210) { this.client.setScreen(new EditHudScreen(this)); return true; } // FIXED!
            return true;
        }
